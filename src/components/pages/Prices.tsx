...
export const Prices = (props: Props) => {
    ...
    useEffect(()=>{
        ...
        } else if (searchParams.get("topPrice") === "true") {
            setFilteredSneakers(sneakers.filter(s => s.price > 100));
        } else {
    ...
    return (
        <div>
            ...
            <button onClick={handleTopPrice} className={styles.buttonStyle}>Top price</button>
